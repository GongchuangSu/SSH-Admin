               ...
               <div class="panel panel-primary">
                  ...
                  <div class="list-group">
                     ...
                     <div class="collapse pos-absolute" id="tables">
                        <a href="basic-table" data-toggle="collapse" data-target="#tables" class="list-group-item sub-item">
                        <span>&nbsp;&nbsp;<i class="icon-table"><span>&nbsp;基本表格</span></i></span>
                        </a>
                        <a href="editable-table" data-toggle="collapse" data-target="#tables" class="list-group-item sub-item active">
                  ...
                  <form action="#" id="form" class="form-horizontal">
                     ...
                     <div class="form-body">
                        <div class="form-group">
                           ...
                           <div class="col-md-9">
                              <input name="isbn" palceholder="ISBN" class="form-control" type="text"/>
                           </div>
                        </div>
                        <div class="form-group">
                           <label class="control-label col-md-3">书名</label>
                           <div class="col-md-9">
                              <input name="title" palceholder="书名" class="form-control" type="text"/>
                           </div>
                        </div>
                        <div class="form-group">
                           <label class="control-label col-md-3">作者</label>
                           <div class="col-md-9">
                              <input name="author" palceholder="作者" class="form-control" type="text"/>
                           </div>
                        </div>
                        <div class="form-group">
                           <label class="control-label col-md-3">类别</label>
                           <div class="col-md-9">
                              <input name="category" palceholder="类别" class="form-control" type="text"/>
                           </div>
                        </div>
                        <div class="form-group">
                           <label class="control-label col-md-3">价格</label>
                           <div class="col-md-9">
                              <input name="price" palceholder="价格" class="form-control" type="text"/>
                           </div>
                        </div>
                     </div>
                  </form>
